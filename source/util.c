...
wchar_t mapa_caracteres_estaticos[] = { INIMIGO,   L'\x2694', '}',       L'\x2694', CAMINHO_LIVRE, L'\x22C5', '/',
                                        L'\x22C5', '{',       L'\x22C5', SAIDA,     L'\x2691',     0,         0 };

Mapa_Cores mapa_cores[] = { { PAREDE, L"\e[0;34m" }, { TRILHA, L"\e[0;32m" },  { INIMIGO, L"\e[0;31m" },
